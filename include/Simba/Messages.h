...
struct OrderUpdate {
    ...
    const std::string format() const {
        return "{\"mdEntryID\" : " + std::to_string(mdEntryID) + ", "
                  + "\"mdEntryPx\" : " + std::to_string(mdEntryPx) + ", "
                  + "\"mdEntrySize\" : " + std::to_string(mdEntrySize) + ", "
                  + "\"mdFlags\" : " + std::to_string(mdFlags) + ", "
                  + "\"mdFlags2\" : " + std::to_string(mdFlags2) + ", "
                  + "\"securityID\" : " + std::to_string(securityID) + ", "
